...
Generated on  2023-07-03 17:12:33.471529
...
*/
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        new Lineshapes::GSpline("K(1)(1270)bar-", K_1_1270_minus_M, K_1_1270_minus_W, 0.0, M_12_4, FF::BL2,
            1.5, K_1_1270bar_minus_SplineArr, Lineshapes::spline_t(0.6,3.0,40)),
        new Lineshapes::RBW("K*(892)bar0", Kst_892_0_bar_M, Kst_892_0_bar_W, 1.0, M_12, FF::BL2),
        new Lineshapes::GSpline("K(1)(1270)bar-", K_1_1270_minus_M, K_1_1270_minus_W, 0.0, M_13_4, FF::BL2,
            1.5, K_1_1270bar_minus_SplineArr, Lineshapes::spline_t(0.6,3.0,40)),
        new Lineshapes::RBW("K*(892)bar0", Kst_892_0_bar_M, Kst_892_0_bar_W, 1.0, M_13, FF::BL2)
    });
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        new Lineshapes::GSpline("K(1)(1270)bar-", K_1_1270_minus_M, K_1_1270_minus_W, 0.0, M_24_1, FF::BL2,
            1.5, K_1_1270bar_minus_SplineArr, Lineshapes::spline_t(0.6,3.0,40)),
        new Lineshapes::RBW("omega(782)0", omega_782_M, omega_782_W, 1.0, M_24, FF::BL2),
        new Lineshapes::GSpline("K(1)(1270)bar-", K_1_1270_minus_M, K_1_1270_minus_W, 0.0, M_34_1, FF::BL2,
            1.5, K_1_1270bar_minus_SplineArr, Lineshapes::spline_t(0.6,3.0,40)),
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        new Lineshapes::RBW("K(1)(1400)bar-", K_1_1400_minus_M, K_1_1400_minus_W, 0.0, M_12_4, FF::BL2),
        new Lineshapes::RBW("K*(892)bar0", Kst_892_0_bar_M, Kst_892_0_bar_W, 1.0, M_12, FF::BL2),
        new Lineshapes::RBW("K(1)(1400)bar-", K_1_1400_minus_M, K_1_1400_minus_W, 0.0, M_13_4, FF::BL2),
        new Lineshapes::RBW("K*(892)bar0", Kst_892_0_bar_M, Kst_892_0_bar_W, 1.0, M_13, FF::BL2)
    });
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        new Lineshapes::GSpline("K(1460)bar-", K_1460_minus_M, K_1460_minus_W, 0.0, M_24_1, FF::BL2,
            1.5, K_1460bar_minus_SplineArr, Lineshapes::spline_t(0.6,3.0,40)),
        new Lineshapes::kMatrix("PiPi30", 0, true,
            sA_0, sA, s0_prod, s0_scatt,
            f_scatt, IS_poles,
            PiPi3_M, PiPi3_W, 0.0, M_24, FF::BL2, 1.5),
        new Lineshapes::GSpline("K(1460)bar-", K_1460_minus_M, K_1460_minus_W, 0.0, M_34_1, FF::BL2,
            1.5, K_1460bar_minus_SplineArr, Lineshapes::spline_t(0.6,3.0,40)),
        new Lineshapes::kMatrix("PiPi30", 0, true,
            sA_0, sA, s0_prod, s0_scatt,
            f_scatt, IS_poles,
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        ...
        new Lineshapes::kMatrix("PiPi10", 1, true,
            sA_0, sA, s0_prod, s0_scatt,
            f_scatt, IS_poles,
            PiPi1_M, PiPi1_W, 0.0, M_34, FF::BL2, 1.5),
        new Lineshapes::RBW("K*(892)bar0", Kst_892_0_bar_M, Kst_892_0_bar_W, 1.0, M_13, FF::BL2),
        new Lineshapes::kMatrix("PiPi10", 1, true,
            sA_0, sA, s0_prod, s0_scatt,
            f_scatt, IS_poles,
            PiPi1_M, PiPi1_W, 0.0, M_24, FF::BL2, 1.5)
    });
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        new Lineshapes::GSpline("a(1)(1260)+", a_1_1260_plus_M, a_1_1260_plus_W, 0.0, M_24_3, FF::BL2,
            1.5, a_1_1260_plus_SplineArr, Lineshapes::spline_t(0.18412,1.9,40)),
        new Lineshapes::RBW("rho(770)0", rho_770_0_M, rho_770_0_W, 1.0, M_24, FF::BL2),
        new Lineshapes::GSpline("a(1)(1260)+", a_1_1260_plus_M, a_1_1260_plus_W, 0.0, M_34_2, FF::BL2,
            1.5, a_1_1260_plus_SplineArr, Lineshapes::spline_t(0.18412,1.9,40)),
        new Lineshapes::RBW("rho(770)0", rho_770_0_M, rho_770_0_W, 1.0, M_34, FF::BL2)
    });
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        new Lineshapes::RBW("rho(770)0", rho_770_0_M, rho_770_0_W, 1.0, M_24, FF::BL2),
        new Lineshapes::FOCUS("KPi10", Lineshapes::FOCUS::Mod::I32, KPi1_0_M, KPi1_0_W, 0.0, M_13, FF::BL2, 1.5),
        new Lineshapes::RBW("rho(770)0", rho_770_0_M, rho_770_0_W, 1.0, M_34, FF::BL2),
        new Lineshapes::FOCUS("KPi10", Lineshapes::FOCUS::Mod::I32, KPi1_0_M, KPi1_0_W, 0.0, M_12, FF::BL2, 1.5)
    });
    ...
    line_factor_list.push_back(std::vector<Lineshape*>{
        new Lineshapes::RBW("rho(770)0", rho_770_0_M, rho_770_0_W, 1.0, M_24, FF::BL2),
        new Lineshapes::FOCUS("KPi10", Lineshapes::FOCUS::Mod::Kpi, KPi1_0_M, KPi1_0_W, 0.0, M_13, FF::BL2, 1.5),
        new Lineshapes::RBW("rho(770)0", rho_770_0_M, rho_770_0_W, 1.0, M_34, FF::BL2),
        new Lineshapes::FOCUS("KPi10", Lineshapes::FOCUS::Mod::Kpi, KPi1_0_M, KPi1_0_W, 0.0, M_12, FF::BL2, 1.5)
    });
