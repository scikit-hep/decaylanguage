...
parsed_models = (
    ...
    ("SVV_NONCPEIGEN", [0.507e12, 0.39, 1.387, 0.322, 0.31, 0.941, 0, 0.107, 1.42, 0.02, 0, 0.02, 0, 0.02, 0]),
    ("SVVHELCPMIX", [1.0, 0.0, 1.0, 0.0, 1.0, 0.0, 8.15e24, 17.8e12, 65.78e10, 8.42e10, 0.0, 0.025]),
