...
@pytest.mark.parametrize("dc,expected", [
    (DecayChain("D0", {"D0":dm2, "K_S0":dm3, "pi0":dm4}), "D0 -> (K_S0 -> pi+ pi-) (pi0 -> gamma gamma)"),
    (DecayChain("D*+", {"D*+":dm1, "D0":dm2, "K_S0":dm3, "pi0":dm4}), "D*+ -> (D0 -> (K_S0 -> pi+ pi-) (pi0 -> gamma gamma)) pi+"),
    (DecayChain("B0", {"B0": dm5, "D-": dm6, "tau+": dm7}), "B0 -> (D- -> K+ pi- pi-) nu_tau (tau+ -> anti-nu_tau pi+ pi+ pi-)"),
    (DecayChain("B_s0", {"B_s0": dm8, "phi": dm9a, "phi'": dm9b}), "B_s0 -> (phi -> K+ K-) (phi' -> pi+ pi- pi0)"),
])
